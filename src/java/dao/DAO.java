...
public class DAO {
    ...
    public List<Product> getAllProduct() {
        ...
        String query = "select * from product_HE160777";
        try {
    ...
    public List<Category> getAllCategory() {
        ...
        String query = "select * from Category_HE160777";
        try {
            con = new DBContext().getConnection();
            ps = con.prepareStatement(query);
            rs = ps.executeQuery();
    ...
    public List<SubCategory> getAllSubCategory(String cid) {
        ...
        String query = "select * from SubCategory_HE160777 where CategoryID = ?";
        try {
            con = new DBContext().getConnection();
            ps = con.prepareStatement(query);
            ps.setString(1, cid);
    ...
    public Product getProductByID(String pid) {
        ...
        String query = "select * from Product_HE160777 where id = ?";
    ...
    public List<Product> searchProductsByName(String name) {
        List<Product> list = new ArrayList<>();
        String query = "select * from Product_HE160777 where [Name] like ? ";
    ...
    public Account login(String username, String password) {
        String query = "select * from account_HE160777 where username = ? and Password = ? COLLATE Latin1_General_CS_AS";
        try {
            con = new DBContext().getConnection();
            ps = con.prepareStatement(query);
    ...
    public boolean checkAccoutExist(String username) {
        String query = "select * from account_HE160777 where username = ? COLLATE Latin1_General_CS_AS";
        try {
            con = new DBContext().getConnection();
            ps = con.prepareStatement(query);
            ps.setString(1, username);
    ...
    public boolean checkEmailExist(String email) {
        String query = "select * from account_HE160777 where email = ? COLLATE Latin1_General_CS_AS";
        try {
            con = new DBContext().getConnection();
            ps = con.prepareStatement(query);
    ...
    public void signup(String fullname, String email, String sdt, String address, String date, String username, String password) {
        String query = "insert into Account_HE160777\n"
                + "values (0,?,?,?,?,?,?,?)";
        try {
            con = new DBContext().getConnection();
            ps = con.prepareStatement(query);
    ...
    public void updateProfile(String username, String fullname, String email, String sdt, String address, String date) {
        String query = "update Account_HE160777 set FullName = ?,Email = ?,sdt = ?,[address] = ?,[date]=?"
                + " where username = ?";
    ...
    public void changePass(String username, String newPass) {
        String query = "update Account_HE160777\n"
                + "set Password = ?\n"
                + "where Username = ?";
    ...
    public void deleteProduct(String pid) {
        String query = "delete from Product_HE160777 where id = ?";
        try {
            con = new DBContext().getConnection();
            ps = con.prepareStatement(query);
            ps.setString(1, pid);
    ...
    public void updateProduct(String pid, String name, String image, String price, String discount, String quantity, String detail, String information) {
        String query = "update Product_HE160777 set [Name] = ?,[Image] = ?,\n"
    ...
    public int getMaxIDProduct(String scid) {
        ...
        int maxID = 0;
        String query = "select * from STRING_SPLIT((select top(1) Id from product_HE160777 where SubCategory = ? order by ID desc),'-')";
        try {
            con = new DBContext().getConnection();
            ps = con.prepareStatement(query);
            ps.setString(1, scid);
    ...
    public void addProduct(String pid, String name, String image, String price, String discount, String quantity, String detail, String information, String scid) {
        String query = "INSERT INTO  Product_HE160777 \n"
                + "VALUES\n"
                + "  (?,?,?,?,?,?,?,0,?,'No',?)";
        try {
            con = new DBContext().getConnection();
    ...
    public List<Item> getAllItemInCart(String username) {
        String query = "select i.iid,pid,quantity from item_HE160777 i,Cart_HE160777 c where i.iID = c.iID and username = ?";
    ...
    public String getMaxIDItem(String username) {
        String query = "select top(1) iid from item_HE160777 order by iid desc";
        int maxID = 0;
        try {
            con = new DBContext().getConnection();
            ps = con.prepareStatement(query);
    ...
    public void addToCart(String iid, String pid, String quantity, String username) {
        String query = "insert into item_HE160777 \n"
                + "values(?,?,?)\n"
                + "insert into cart_HE160777 \n"
                + "values (?,?)";
        try {
            con = new DBContext().getConnection();
            ps = con.prepareStatement(query);
    ...
    public void deleteFromCart(String iid) {
        String query = "delete from Cart_HE160777 where iID = ?\n"
                + "delete from item_HE160777 where iID = ?";
        try {
            con = new DBContext().getConnection();
            ps = con.prepareStatement(query);
            ps.setString(1, iid);
    ...
    public boolean checkProductExitInCart(String pid) {
        String query = "select * from item_HE160777 where pid = ?";
        try {
            con = new DBContext().getConnection();
            ps = con.prepareStatement(query);
            ps.setString(1, pid);
    ...
    public void updateItemInCart(String pid, String quantity) {
        String query = "update item_HE160777 set quantity = ? where pid = ?";
        try {
            con = new DBContext().getConnection();
            ps = con.prepareStatement(query);
    ...
    public int getQuantityInCart(String pid) {
        int quantity = 0;
        String query = "select quantity from item_HE160777 where pid = ?";
        try {
            con = new DBContext().getConnection();
            ps = con.prepareStatement(query);
            ps.setString(1, pid);
    ...
    public List<Account> getAllAccounts() {
        ...
        String query = "select * from account_HE160777";
        try {
            con = new DBContext().getConnection();
            ps = con.prepareStatement(query);
            rs = ps.executeQuery();
    ...
    public String getMaxIDOrder(String username) {
        String query = "select top(1) ID from [order_HE160777] order by ID desc";
        int maxID = 0;
        try {
            con = new DBContext().getConnection();
            ps = con.prepareStatement(query);
    ...
    public void addOrder(String ID, String username, String iid, String fullName, String sdt, String email, String address, String note, String date, String totalPrice, String pid, String quantity) {
        String query = "insert into [order_HE160777] \n"
                + "values(?,?,?,?,?,?,?,?,?,'Yes',?,?,?)";
        try {
            con = new DBContext().getConnection();
            ps = con.prepareStatement(query);
    ...
    public List<itemOrder> getAllOrders(String username) {
        ...
        String query = "select * from [Order_HE160777] where username = ?";
        try {
            con = new DBContext().getConnection();
            ps = con.prepareStatement(query);
            ps.setString(1, username);
    ...
    public itemOrder getItemOrders(String username, String pid, String oid) {
        itemOrder i = null;
        String query = "select * from [Order_HE160777] where username = ? and id = ? and pid = ?";
        try {
            con = new DBContext().getConnection();
            ps = con.prepareStatement(query);
            ps.setString(1, username);
